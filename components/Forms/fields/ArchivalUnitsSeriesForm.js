...
export const ArchivalUnitsSeriesForm = ({type, readOnly}) => {
  return (
    <React.Fragment>
      <Col xs={4}>
      ...
      <Col xs={4}>
        <Form.Item label="Subfonds" name="subfonds">
          <Input disabled />
        </Form.Item>
      </Col>
      <Col xs={14}>
        <Form.Item label="Subfonds Title" name="subfonds_title">
          <Input disabled />
        </Form.Item>
      </Col>
      <Col xs={6}>
        <Form.Item label="Subfonds Acronym" name="subfonds_acronym">
          <Input disabled />
        </Form.Item>
      </Col>
      <Col xs={4}>
