...
const configMenu = [
  ...
  {name: 'Finding Aids', icon: <FileOutlined/>, module: 'finding-aids', group: ['Finding Aids', 'Undefined Materials'], submenu: [
      ...
      {name: 'Unprocessed Materials', group: ['Unprocessed Materials'], link: '/finding-aids/undefined-materials'},
    ]},
